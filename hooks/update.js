...
process.stdin.on("end", () => {
  ...
  const out = { state, label, tool: p.tool_name || "", project, instance, sessionId: p.session_id || "", transcript: p.transcript_path || prev.transcript || "", entrypoint, term_program: termProgram, pid: process.ppid, started: true, startedAt, ts };
  try {
